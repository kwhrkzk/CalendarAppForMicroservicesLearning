...
{
    public class TODOViewModel : IConfirmNavigationRequest, IRegionMemberLifetime, IDisposable, INotifyPropertyChanged
    {
...
#pragma warning restore 0067
        ...
        #endregion
        public TODOModel Model { get; }
        public TODOViewModel(TODOModel _model)
        {
            Model = _model;
        }
